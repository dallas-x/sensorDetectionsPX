function BotDetector(args) {
  ...
  if (
    selectedTests.length == 0 ||
    selectedTests.indexOf(BotDetector.Tests.MOUSEDOWN) != -1
  ) {
    self.tests[BotDetector.Tests.MOUSEDOWN] = function () {
      var e = function () {
        self.tests[BotDetector.Tests.MOUSEDOWN] = true;
        self.update();
        self.unbindEvent(window, BotDetector.Tests.MOUSEDOWN, e);
      };
      self.bindEvent(window, BotDetector.Tests.MOUSEDOWN, e);
    };
  }
  if (
    selectedTests.length == 0 ||
    selectedTests.indexOf(BotDetector.Tests.TOUCHSTART) != -1
  ) {
    self.tests[BotDetector.Tests.TOUCHSTART] = function () {
      var e = function () {
        self.tests[BotDetector.Tests.TOUCHSTART] = true;
        self.update();
        self.unbindEvent(window, BotDetector.Tests.TOUCHSTART, e);
      };
      self.bindEvent(window, BotDetector.Tests.TOUCHSTART, e);
    };
  }
  if (
    selectedTests.length == 0 ||
    selectedTests.indexOf(BotDetector.Tests.TOUCHMOVE) != -1
  ) {
    self.tests[BotDetector.Tests.TOUCHMOVE] = function () {
      var e = function () {
        self.tests[BotDetector.Tests.TOUCHMOVE] = true;
        self.update();
        self.unbindEvent(window, BotDetector.Tests.TOUCHMOVE, e);
      };
      self.bindEvent(window, BotDetector.Tests.TOUCHMOVE, e);
    };
  }
  if (
    selectedTests.length == 0 ||
    selectedTests.indexOf(BotDetector.Tests.TOUCHEND) != -1
  ) {
    self.tests[BotDetector.Tests.TOUCHEND] = function () {
      var e = function () {
        self.tests[BotDetector.Tests.TOUCHEND] = true;
        self.update();
        self.unbindEvent(window, BotDetector.Tests.TOUCHEND, e);
      };
      self.bindEvent(window, BotDetector.Tests.TOUCHEND, e);
    };
  }
  if (
    selectedTests.length == 0 ||
  ...
  // Device Motion https://developer.mozilla.org/en-US/docs/Web/API/DeviceMotionEvent/DeviceMotionEvent
  if (
    selectedTests.length == 0 ||
